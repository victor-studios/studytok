...
const videos = [
  ...
  'https://res.cloudinary.com/demo/video/upload/c_fill,h_1280,w_720/elephants.mp4',
  'https://res.cloudinary.com/demo/video/upload/c_fill,h_1280,w_720/kitten-playing.mp4'
];
  ...
  for (let c of classesData) {
    ...
    for (let s of subjects) {
      ...
      for (let chIdx = 1; chIdx <= 2; chIdx++) {
        ...
        // Create 2 lessons per chapter
        for (let lIdx = 1; lIdx <= 2; lIdx++) {
          const lessonTitle = `Lesson ${lIdx}: Intro to ${s.name} part ${chIdx}`;
          ...
          await supabase
            ...
            .insert({
              ...
              lesson_number: lIdx,
              total_lessons_in_chapter: 2,
              video_url: videos[(chIdx + lIdx) % videos.length],
